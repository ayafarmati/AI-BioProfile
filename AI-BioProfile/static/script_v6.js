                ...
                if (value.length === 0) {
                    ...
                    value.forEach((item) => {
                        if (typeof item === 'string' || typeof item === 'number') {
                            ...
                            // [NEW] Ajout de checkbox pour la selection
                            if (key === 'projets_et_experiences' || key === 'formations' || key === 'langues') {
                                ...
                                titleSpan.textContent = 'Inclure cet élément dans le PPTX';
                                ...
                                // Effet de grisage si décoché
                                checkbox.addEventListener('change', (e) => {
                                    if(e.target.checked) {
                                        objContainer.style.opacity = '1';
                                    } else {
                                        objContainer.style.opacity = '0.4';
                                    }
                                });
                            }
                ...
                if (containerType === 'array') {
                    ...
                    // Cas complexe : liste d'objets (ex: projets ou langues)
                        ...
                        objItems.forEach(objDiv => {
                            // [NEW] Vérification de la checkbox
